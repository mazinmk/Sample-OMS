...
KAFKA_RAW_TOPIC_NAME = "new_raw_orders"
KAFKA_BOOTSTRAP_SERVERS = '10.0.0.6:9092'
LOG_FILE_NAME = "logs/generateorder.log"
...
def update_order_status(order_list):
    ...
    try:
        ...
        order_status_col = my_mongo_db.db.order_status
...
def publish_data_to_kafka(flatten_data):
    ...
    try:
        ...
        for each_record in flatten_data:
            ...
            kafka_producer.send(KAFKA_RAW_TOPIC_NAME, each_record)
